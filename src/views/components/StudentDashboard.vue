        ...
        <div class="d-flex flex-column flex-md-row justify-space-between align-center">
          <div class="header-content">
            <h1 class="text-h4 font-weight-bold  mb-2">
              <v-icon large color="white" class="mr-2">mdi-school</v-icon>
              O'quvchilar ma'lumotlari
            </h1>
            <p class="text-subtitle-1 white--text">
              <v-icon small color="white" class="mr-1 ml-2">mdi-information-outline</v-icon>
              Ta'lim markazidagi o'quvchilar ro'yxati
              <v-chip x-small outlined color="white" class="ml-2 white--text ">{{ filteredStudents.length }} ta o'quvchi</v-chip>
            </p>
          </div>
      ...
      <v-card class="rounded-lg table-card" elevation="3">
        <div class="data-header pa-4">
          <div class="d-flex align-center">
            ...
            <v-chip class="ml-2" color="blue" small>{{ filteredStudents.length }} ta</v-chip>
          </div>
        ...
        >
          ...
          <template v-slot:item.name="{ item }">
            <div class="d-flex align-center">
              <v-avatar size="32" color="blue lighten-4" class="mr-2">
                <span class="blue--text font-weight-bold">{{ getInitials(item.name) }}</span>
              </v-avatar>
          ...
          <template v-slot:no-data>
            <div class="pa-6 text-center empty-state">
              ...
              <h3 class="text-subtitle-1 font-weight-medium grey--text mt-3">O'quvchilar topilmadi</h3>
    ...
    data() {
      return {
        ...
        headers: [
          ...
          { text: "Amallar", value: "actions", sortable: false, align: "center", width: "120px" },
        ],
        students: [],
        subjects: [],
        teachers: [],
    ...
    methods: {
      ...
      getSubjectColor(subject) {
        ...
        if (subject !== this.lastSubject) {
          const colors = ['blue', 'indigo', 'deep-purple', 'teal', 'green', 'orange', 'red'];
